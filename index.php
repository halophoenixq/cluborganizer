...
<head>
	...
	$query .= "FROM core.photo LEFT JOIN core.photo_type on photo.photo_type_id = photo_type.photo_type_id LEFT JOIN core.event ON photo.event_id = event.event_id LEFT JOIN core.event_type ON event.event_type_id = event_type.event_type_id ";
