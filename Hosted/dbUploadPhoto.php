...
&& in_array($extension, $allowedExts)){
    ...
    //if cover photo
    if($type_id == '1'){
        $query = "SELECT PHOTO_ID FROM PHOTO WHERE photo_type_id = $type_id AND event_id = $event_id";
        ...
        if(mysqli_num_rows($result) > 0){
            ...
            $query = "INSERT INTO PHOTO(PHOTO_TYPE_ID, EVENT_ID, PATH, NAME, DESCRIPTION) ";
