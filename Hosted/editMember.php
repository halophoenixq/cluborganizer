...
<head>
  ...
  // members
  $query = "SELECT MEMBER_ID, FIRST_NAME, LAST_NAME, USERNAME, MAJOR.NAME AS MNAME, PHONE, EMAIL, CLASS.NAME AS CNAME, RANK.NAME AS RNAME, CLASS_STANDING.NAME AS CSNAME, GRAD_YEAR, ACTIVE ";
...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <!-- Member Listing -->
        <h2 class="form-heading">Select Member to Edit</h2>
  ...
  <form id='member_more' action="editMemberEntry.php" method="POST">
