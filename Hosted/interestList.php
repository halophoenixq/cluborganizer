...
<head>
  ...
  $query .= "FROM PROSPECTIVE LEFT JOIN CLASS_STANDING ON PROSPECTIVE.CLASS_STAND_ID = CLASS_STANDING.CLASS_STAND_ID LEFT JOIN MAJOR ON PROSPECTIVE.MAJOR_ID = MAJOR.MAJOR_ID ";
