...
<head>
  ...
  $query .= "FROM MEMBER LEFT JOIN CLASS ON MEMBER.CLASS_ID = CLASS.CLASS_ID LEFT JOIN RANK ON MEMBER.RANK_ID = RANK.RANK_ID LEFT JOIN CLASS_STANDING ON MEMBER.CLASS_STAND_ID = CLASS_STANDING.CLASS_STAND_ID ";
